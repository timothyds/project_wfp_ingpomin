                            ...
                            @can('delete-permission', Auth::user())
                                ...
                                <form method="POST" action="{{ route('customer.destroy', $d->id) }}">
                                    ...
                                    <input type="submit" class="btn btn-danger"
                                        ...
                                        value="Delete" action="{{ route('customer.destroy', $d->id) }}">
                                </form>
                            @endcan
                        </td>
                    </tr>
                        ...
                        <form method="POST" action="{{ route('customer.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="tipetxt"
                                    aria-describedby="tipeHelp" placeholder="Enter Customer Name">
                                <small id="tipeHelp" class="form-text text-muted">Please determine your customer
                                    name.</small>
                                <input type="text" name="address" class="form-control" id="addresstxt"
                                    aria-describedby="tipeHelp" placeholder="Enter Address">
                                <small id="tipeHelp" class="form-text text-muted">Please determine your customer
                                    address.</small>
                            </div>
                    </div>
