...
<div class="container-fluid">
    <form method="POST" action="{{ route('facility.store') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" id="facilitytxt" aria-describedby="tipeHelp"
                placeholder="Enter Facility Name">
            <small id="tipeHelp" class="form-text text-muted">Please determine your facility name.</small>
            <input type="text" name="description" class="form-control" id="descriptiontxt" aria-describedby="tipeHelp"
